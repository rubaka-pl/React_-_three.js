      ...
      <motion.div
        ...
        <motion.div variants={itemVariants} className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img src={`${baseUrl}assets/grid1.png`} alt="grid-1" className="w-full sm:h-[276px] h-fit object-contain" />
            <div>
        ...
        <motion.div variants={itemVariants} className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img src={`${baseUrl}assets/grid2.png`} alt="grid-2" className="w-full sm:h-[276px] h-fit object-contain" />
            <div>
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <Button
                ...
                href={`${baseUrl}Daniel S. Frontend developer(eng).pdf`}
                download
              />
            </div>
          </div>
        ...
        <motion.div variants={itemVariants} className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container justify-center">
            <img src={`${baseUrl}assets/grid3.png`} alt="grid-3" className="w-full sm:h-[266px] h-fit object-contain" />
            <div>
